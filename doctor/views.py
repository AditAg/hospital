                    ...
                    if action=='book':
                        ...
                        for i in d:
                            ...
                            if i['start_time']>=add(end_time,-5):
                                ...
                                cursor.execute('UPDATE TABLE Schedule SET start_time=%s where doctor_id = %s and date = %s and start_time = %s and'
                                ...
                                cursor.execute('UPDATE TABLE Schedule SET end_time=%s where doctor_id = %s and date = %s and start_time = %s and'
